// Import Ireland geometry
var ireland = ee.FeatureCollection('projects/bamacgabhann/assets/Ireland');

// Load global forest cover data for ireland for 2015-2021
var gfc2021 = ee.Image('UMD/hansen/global_forest_change_2021_v1_9').clip(ireland);
...
//var gain2012v = gain2012.reduceToVectors({
//  geometry: ireland,
//  crs: gain2012.projection(),
//  scale: 30,
...
//  collection: gain2012v,
//  description: 'forest_gain_2000_2012',
//  fileFormat: 'SHP',
//});

// Subset tree cover gain 2000-2020 and add in a different blue
//var gain2020 = ee.Image('projects/glad/GLCLU2020/Forest_gain').clip(ireland);
...
// Load Fire data
var fire21 = ee.Image('users/sashatyu/2001-2021_fire_forest_loss/EUR_fire_2001-21_thresh_final').clip(ireland);
...
// Sum the total value of forest loss pixels in ireland.
...
var chartT = ui.Chart.array.values({
  ...
  .setOptions({
    title: 'Total GFC Forest Cover Loss in Ireland 2000-2021',
...
var chartH = ui.Chart.array.values({
  ...
  .setOptions({
    title: 'High Certainty Fire Forest Cover Loss in Ireland 2000-2021',
    hAxis: {title: 'Year', format: '####'},
    vAxis: {title: 'Area (square meters)'},
    legend: { position: "none" },
    lineWidth: 1,
...
var chartM = ui.Chart.array.values({
  ...
  .setOptions({
    title: 'Medium Certainty Fire Forest Cover Loss in Ireland 2000-2021',
    hAxis: {title: 'Year', format: '####'},
    vAxis: {title: 'Area (square meters)'},
    legend: { position: "none" },
    lineWidth: 1,
...
var chartL = ui.Chart.array.values({
  ...
  .setOptions({
    title: 'Low Certainty Fire Forest Cover Loss in Ireland 2000-2021',
    hAxis: {title: 'Year', format: '####'},
    vAxis: {title: 'Area (square meters)'},
    legend: { position: "none" },
    lineWidth: 1,
...
var chartN = ui.Chart.array.values({
  ...
  .setOptions({
    title: 'Non-Fire Forest Cover Loss in Ireland 2000-2021',
    hAxis: {title: 'Year', format: '####'},
    vAxis: {title: 'Area (square meters)'},
    legend: { position: "none" },
    lineWidth: 1,
...
var chartHOnGain12 = ui.Chart.array.values({
  ...
  .setOptions({
    title: 'High Certainty Fire Forest Cover Loss in Ireland 2013-2021 on Forest Cover Gained 2000-2012',
    hAxis: {title: 'Year', format: '####'},
    vAxis: {title: 'Area (square meters)'},
    legend: { position: "none" },
    lineWidth: 1,
...
var chartMOnGain12 = ui.Chart.array.values({
  ...
  .setOptions({
    title: 'Medium Certainty Fire Forest Cover Loss in Ireland 2013-2021 on Forest Cover Gained 2000-2012',
    hAxis: {title: 'Year', format: '####'},
    vAxis: {title: 'Area (square meters)'},
    legend: { position: "none" },
    lineWidth: 1,
...
var chartLOnGain12 = ui.Chart.array.values({
  ...
  .setOptions({
    title: 'Low Certainty Fire Forest Cover Loss in Ireland 2013-2021 on Forest Cover Gained 2000-2012',
    hAxis: {title: 'Year', format: '####'},
    vAxis: {title: 'Area (square meters)'},
    legend: { position: "none" },
    lineWidth: 1,
